...
public class AuthRestController {
     ...
     * Accepts JSON with email and password, authenticates user, and returns success response
     * Session is automatically created by Spring Security
     */
    @PostMapping("/login")
     ...
     * Accepts JSON with email and verification code
     */
    @PostMapping("/verify")
    public ResponseEntity<?> verify(@Valid @RequestBody Map<String, String> verifyRequest) {
        try {
     ...
     * Useful for React to check authentication status
     */
    @GetMapping("/check")
